...
var colorWorks = [
    [200, 150, 100], //0 展示空間
    [100, 200, 150], //1 気配のふるまい
    [150, 100, 200], //2 Inside-Out,Outside-In,Or
    [100, 100, 200], //3 emotional distance
    [50, 200, 200], //4 大爆走！オーディオレーシング
    [200, 50, 200], //5 ぼやける境界
    [50, 50, 200], //6 対雨
    [200, 50, 50],z //7 Graviter
    [50, 200, 50], //8 居の中の蛙
    [200, 200, 50], //9 NUM. (Ningen Unique Mirror)
    [0, 0, 0] //10 黒線
];
